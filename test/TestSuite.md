...
| [LauncherAgent] | [LauncherAgent.md](LauncherAgent.md) | 6 | Multi-instance gateway lifecycle REST API: port auto-allocation, independent instances, duplicate-port rejection, delete-while-running rejection, host info, edit-in-place via PUT |
